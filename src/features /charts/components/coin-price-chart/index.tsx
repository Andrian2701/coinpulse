...
import { ErrorMessage, TableHeading } from '@/shared/components'
import { ChartMetricsSelect } from './chart-metrics-select'
...
import { ChartTypeEnum, CoinPriceMetricsEnum, TimeRange } from '../../types/coins-types'

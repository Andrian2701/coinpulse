        ...
        <div className="flex justify-between flex-col md:flex-row gap-4">
            <div className="p-8 w-full h-[125px] border border-light-gray flex items-center justify-start gap-4 rounded-lg">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <span className="text-[16px] font-bold text-black">{data?.market_cap_percentage.btc.toFixed(2)}%</span>
                </div>
            </div>
            <div className="p-8 w-full h-[125px] border border-light-gray flex items-center justify-start gap-4 rounded-lg">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <span className="text-[16px] font-bold text-black">{data?.market_cap_percentage.eth.toFixed(2)}%</span>
                </div>
            </div>
            <div className="p-8 w-full h-[125px] border border-light-gray flex items-center justify-start gap-4 rounded-lg">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <span className="text-[16px] font-bold text-black">{data?.market_cap_percentage.usdt.toFixed(2)}%</span>
                </div>
            </div>
        </div>
    )
